...
n-gram の数学的背景、計算方法、Python による実装例、スムージングの扱いなどを整理しながら学習したプロセスを公開しています。
...
- 言語モデルの歴史（NNLM → word2vec → Transformer）へ続く理解の土台を作る  
...
- Laplace smoothing / Kneser-Ney smoothing などの改善が必要  
- 深層学習以前の言語モデルの基盤となっていた  
